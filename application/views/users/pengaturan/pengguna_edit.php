                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control" name="level" required>
                        ...
                        <option value="tu" <?php if($user->level == "tu"){echo "selected";} ?>>Kepala TU</option>
                        <option value="kepalasekolah" <?php if($user->level == "kepalasekolah"){echo "selected";} ?>>Kepala Sekolah</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
