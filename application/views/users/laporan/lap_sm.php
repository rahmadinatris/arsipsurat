              ...
              <form class="form-inline" action="" method="post">
                <div class="form-group">Dari Tanggal
                  <div class="input-group">
                    ...
                    <input type="date" name="tgl1" id="tgl1" class="form-control daterange-single" value="" maxlength="10" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="icon-calendar22"></i></div>
                    <input type="date" name="tgl2" id="tgl2" class="form-control daterange-single" value="" maxlength="10" required>
                  </div>
                </div>
