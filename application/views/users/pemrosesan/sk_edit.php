...
<div class="content-wrapper">
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Edit Surat Keluar Baru</legend>
                <?php
                echo $this->session->flashdata('msg');
                ?>
                <div class="msg"></div>
                <?php foreach ($query as $query) { ?>
                <form class="form-horizontal" action="users/editskk" enctype="multipart/form-data" method="post">
  ...
  <input type="hidden" name="id_sk" id="id_sk" class="form-control" placeholder="" value="<?= $query->id_sk;  ?>" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
    												<input type="text" name="tujuan_surat" id="tujuan_surat" class="form-control" value="<?= $query->tujuan_surat;  ?>" placeholder="">
    									</div>
                    </div>
