...
<?php
	...
	<!-- Theme JS files -->
			<?php if ($sub_menu == '' and $sub_menu3 != 'data_sk'){}elseif ($sub_menu == '' and $sub_menu3 != 'data_sm'){}else{ ?>
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header"style="height: 70px;">
			<a class="navbar-brand" href=""><img src="assets/images/logo.png" alt=""style="width: 55px;height:55px; padding-bottom: 5px;"></a>
					...
					<div class="sidebar-category sidebar-category-visible">
		                ...
		                if ($user->row()->level == 'tu') { ?>
								...
								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") { echo 'active';}?>">
									...
									<ul>
										<li class="<?php if ($sub_menu == "sm") { echo 'active';}?>"><a href="users/get_sm"><i class="icon-folder-download2"></i> SURAT MASUK</a></li>
										<li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a href="users/get_sk"><i class="icon-folder-upload2"></i> SURAT KELUAR</a></li>
									</ul>
								</li>
								<?php
								} ?>
								...
								<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") { echo 'active';}?>">
									...
									<ul>
										<li class="<?php if ($sub_menu == "lap_sm" ) { echo 'active';}?>"><a href="users/lap_sm"><i class="icon-file-empty2"></i> SURAT MASUK</a></li>
										<li class="<?php if ($sub_menu == "lap_sk" ) { echo 'active';}?>"><a href="users/lap_sk"><i class="icon-file-empty2"></i> SURAT KELUAR</a></li>
									</ul>
								</li>
