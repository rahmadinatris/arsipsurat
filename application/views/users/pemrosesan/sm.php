...
<br>
                    <a href="users/sm" class="btn btn-primary">+ <i class="icon-folder-download2"></i> Surat Masuk Baru</a>
        </div>
          ...
          <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalbro<?= $baris->id_sm; ?>"><i class="icon-eye"></i></button>
                    <a href="users/editsm/<?php echo $baris->id_sm; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                    <a href="users/deletesm/<?php echo $baris->id_sm; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                  </td>
                </tr>

                 <!-- Modal -->
<div class="modal fade" id="modalbro<?= $baris->id_sm; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:aqua;">
        <h5 class="modal-title" id="exampleModalLongTitle">Detail Surat Masuk</h5>
      ...
      <div class="modal-body">
       <div class="row">
         ...
         <div class="col-6"><?php echo $baris->asal_surat; ?></div>
         ...
         <div class="col-6"><a href="<?= base_url('/uploads/suratmasuk/').$baris->file_surat; ?>"><?php echo $baris->file_surat; ?></a></div>
