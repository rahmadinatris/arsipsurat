					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class=""><img src="assets/logo.png" alt="Logo Surat Menyurat" width="120"></div>
								<h5 class="content-group">Manajemen Surat<small class="display-block">Silahkan Masuk</small></h5>
								<?php
